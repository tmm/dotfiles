...
function M.foldtext()
  ...
  if line_count > 0 then
    table.insert(result, { " +" .. line_count .. " " .. (line_count == 1 and "line" or "lines") .. " ", "FoldedText" })
  end
...
function M.parse_line(linenr)
  ...
  for id, node, metadata in query:iter_captures(tree:root(), bufnr, linenr - 1, linenr) do
